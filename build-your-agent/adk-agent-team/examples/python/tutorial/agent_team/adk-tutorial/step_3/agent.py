...
# NVIDIA NIM via LiteLLM (precisa NVIDIA_NIM_API_KEY no .env)
# Catálogo: https://build.nvidia.com/models
MODEL_NVIDIA_LLAMA_70B = "nvidia_nim/stepfun-ai/step-3.5-flash"
...
try:
    greeting_agent = Agent(
        ...
        model=LiteLlm(model=MODEL_NVIDIA_LLAMA_70B),
        name="greeting_agent",
